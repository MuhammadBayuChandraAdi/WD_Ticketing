                ...
                <form id="eventForm" class="space-y-4" method="post"
                    ...
                    <div class="form-control">
                        ...
                        <textarea name="deskripsi" placeholder="Deskripsi lengkap tentang event..."
                            class="w-full h-24 textarea textarea-bordered" disabled required>{{ $event->deskripsi }}</textarea>
                    </div>
                    ...
                    <div class="form-control">
                        ...
                        <input type="file" name="gambar" accept="image/*"
                            class="w-full file-input file-input-bordered" disabled />
                        <label class="label">
                    ...
                    <div id="imagePreview" class="overflow-hidden {{ $event->gambar ? '' : 'hidden' }}">
                        ...
                        <div class="max-w-sm avatar">
                            <div class="w-full rounded-lg">
                                @if ($event->gambar)
                                    <img id="previewImg" src="{{ asset('assets/images/' . $event->gambar) }}"
                                        alt="Preview">
                                @else
                                    <img id="previewImg" src="{{ asset('assets/images/Konser.jpeg') }}" alt="Preview">
                                @endif
                            </div>
                        </div>
                    </div>
    ...
    <dialog id="add_ticket_modal" class="modal">
        <form method="POST" action="{{ route('admin.tickets.store') }}" class="modal-box">
            ...
            <div class="mb-4 form-control">
                ...
                <select name="ticket_type_id" id="edit_ticket_type_id" class="w-full select select-bordered"
                    required>
